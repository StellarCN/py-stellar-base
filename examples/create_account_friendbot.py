...
# Print a truncated version of the secret for clarity, avoiding full exposure
# CodeQL [py/clear-text-logging-sensitive-data]: Safe truncated output for testnet demonstration only.
print(
    f"Secret Seed (truncated): {keypair.secret[:5]}...{keypair.secret[-5:]} (Testnet only)"
)
print("-" * 68)
