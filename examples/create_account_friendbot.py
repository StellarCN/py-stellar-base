...
# NOTE: This example uses the Stellar Testnet. The secret is printed
# only for educational purposes and should never be logged in production.
print(f"Secret Seed (Testnet only): {keypair.secret}")
print("-" * 68)
