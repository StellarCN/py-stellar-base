...
def example_verify_challenge_tx_threshold():
    ...
    parsed_challenge_tx = read_challenge_transaction(challenge_tx, server_keypair.public_key, domain_name,
                                                          web_auth_domain, network_passphrase)
    tx, tx_client_account_id = parsed_challenge_tx.transaction, parsed_challenge_tx.client_account_id
    ...
    read_challenge_transaction(challenge_tx, server_keypair.public_key, domain_name,
                                                         web_auth_domain, network_passphrase)
    ...
    if client_account_exists:
        ...
        try:
            signers_found = verify_challenge_transaction_threshold(signed_challenge_tx, server_keypair.public_key,
                                                                   domain_name, web_auth_domain, network_passphrase,
                                                                   threshold, signers)
