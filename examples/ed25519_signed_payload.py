...
from stellar_sdk import SignerKey, SignedPayloadSigner
...
print(f"decoded ed25519 signed payload, account_id = {signed_payload_signer.account_id}, payload = {signed_payload_signer.payload.hex()}")