...
import stellar_base.stellarxdr.StellarXDR_const as const
class PublicKey:
    # XDR definition:
    ...
    switch = property(lambda s: {const.KEY_TYPE_ED25519:s.ed25519,}[s.type])
...
class LedgerHeader:
    ...
    #     } ext;
    # };
    def __init__(self, ledgerVersion=None, previousLedgerHash=None, scpValue=None, txSetResultHash=None, bucketListHash=None, ledgerSeq=None, totalCoins=None, feePool=None, inflationSeq=None, idPool=None, baseFee=None, baseReserve=None, skipList=None, ext=None):
...
class LedgerUpgrade:
    ...
    #         uint32 newBaseFee;
    # };
    def __init__(self, type=None, newLedgerVersion=None, newBaseFee=None):
        self.type = type
        self.newLedgerVersion = newLedgerVersion
        self.newBaseFee = newBaseFee

    switch = property(lambda s: {const.LEDGER_UPGRADE_VERSION:s.newLedgerVersion,const.LEDGER_UPGRADE_BASE_FEE:s.newBaseFee,}[s.type])
...
class LedgerKey:
    ...
    #         } offer;
    # };
    def __init__(self, type=None, account=None, trustLine=None, offer=None):
        self.type = type
        self.account = account
        self.trustLine = trustLine
        self.offer = offer

    switch = property(lambda s: {const.ACCOUNT:s.account,const.TRUSTLINE:s.trustLine,const.OFFER:s.offer,}[s.type])
...
class LedgerEntryChange:
    ...
    #         LedgerKey removed;
    # };
    def __init__(self, type=None, created=None, updated=None, removed=None):
        self.type = type
        self.created = created
        self.updated = updated
        self.removed = removed

    switch = property(lambda s: {const.LEDGER_ENTRY_CREATED:s.created,const.LEDGER_ENTRY_UPDATED:s.updated,const.LEDGER_ENTRY_REMOVED:s.removed,}[s.type])
...
class Signer:
    ...
    #     uint32 weight;
    # };
    def __init__(self, pubKey=None, weight=None):
        self.pubKey = pubKey
        self.weight = weight
...
class Hello:
    ...
    #     uint256 nonce;
    # };
    def __init__(self, ledgerVersion=None, overlayVersion=None, networkID=None, versionStr=None, listeningPort=None, peerID=None, cert=None, nonce=None):
        self.ledgerVersion = ledgerVersion
...
class StellarMessage:
    ...
    # };
    def __init__(self, type=None, error=None, hello=None, auth=None, dontHave=None, peers=None, txSetHash=None, txSet=None, transaction=None, qSetHash=None, qSet=None, envelope=None):
        self.type = type
        self.error = error
        self.hello = hello
        self.auth = auth
...
class AuthenticatedMessage:
    ...
    #     HmacSha256Mac mac;
    # };
    def __init__(self, sequence=None, message=None, mac=None):
