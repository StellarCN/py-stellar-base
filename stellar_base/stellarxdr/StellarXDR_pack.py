# Generated by xdrgen.py from ../xdr/ on Sat Apr 27 13:37:03 2019
...
class StellarXDRPacker(xdrlib.Packer):
    ...
    def pack_OperationType(self, data):
        ...
        if self.check_enum and data not in [const.CREATE_ACCOUNT, const.PAYMENT, const.PATH_PAYMENT, const.MANAGE_SELL_OFFER, const.CREATE_PASSIVE_SELL_OFFER, const.SET_OPTIONS, const.CHANGE_TRUST, const.ALLOW_TRUST, const.ACCOUNT_MERGE, const.INFLATION, const.MANAGE_DATA, const.BUMP_SEQUENCE, const.MANAGE_BUY_OFFER]:
