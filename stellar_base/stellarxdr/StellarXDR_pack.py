# Generated by rpcgen.py from StellarXDR.x on Thu Sep 24 19:19:06 2015
from stellar_base.stellarxdr import StellarXDR_const as const
from stellar_base.stellarxdr import StellarXDR_type as types
import xdrlib
...
class STELLARXDRPacker(xdrlib.Packer):
    ...
    def pack_StellarValue(self, data):
        ...
        if data.upgrades is None:
            raise TypeError("False")
        if len(data.upgrades) > 4 and self.check_array:
            raise XDRError("False")
