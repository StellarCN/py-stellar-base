...
class EffectsCallBuilder(BaseCallBuilder):
    ...
    def for_transaction(self, transaction_hash):
        self.endpoint = 'transactions/{transaction_hash}/effects'.format(transaction_hash=transaction_hash)
        return self

    def for_operation(self, operation_id):
        self.endpoint = 'operations/{operation_id}/effects'.format(operation_id=operation_id)
        return self
