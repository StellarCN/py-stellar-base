...
class BaseAccountsCallBuilder(BaseCallBuilder):
    ...
    See `List All Accounts <https://developers.stellar.org/docs/data/apis/horizon/api-reference/list-all-accounts>`__ for more information.
    ...
    def account_id(self, account_id: str):
        ...
        See `Retrieve an Account <https://developers.stellar.org/docs/data/apis/horizon/api-reference/retrieve-an-account>`__ for more information.
