...
class TransactionV1Envelope:
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionV1Envelope:
    ...
    @classmethod
    def from_json_dict(cls, json_dict: dict) -> TransactionV1Envelope:
        tx = Transaction.from_json_dict(json_dict["tx"])
        signatures = [
