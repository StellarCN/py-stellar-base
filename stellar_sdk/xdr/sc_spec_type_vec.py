...
class SCSpecTypeVec:
    ...
    def unpack(
        ...
        element_type = SCSpecTypeDef.unpack(unpacker, depth_limit - 1)
        return cls(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SCSpecTypeVec:
        return cls.from_json_dict(json.loads(json_str))

    def to_json_dict(self) -> dict:
        return {
            "element_type": self.element_type.to_json_dict(),
        }

    @classmethod
    def from_json_dict(cls, json_dict: dict) -> SCSpecTypeVec:
        element_type = SCSpecTypeDef.from_json_dict(json_dict["element_type"])
        return cls(
            element_type=element_type,
        )
