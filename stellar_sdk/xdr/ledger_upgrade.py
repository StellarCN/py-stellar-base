...
class LedgerUpgrade:
    ...
    @classmethod
    def ledger_upgrade_version(cls, new_ledger_version: Uint32) -> "LedgerUpgrade":
        return cls(
    ...
    @classmethod
    def ledger_upgrade_base_fee(cls, new_base_fee: Uint32) -> "LedgerUpgrade":
        return cls(LedgerUpgradeType.LEDGER_UPGRADE_BASE_FEE, new_base_fee=new_base_fee)

    @classmethod
    def ledger_upgrade_max_tx_set_size(
    ...
    @classmethod
    def ledger_upgrade_base_reserve(cls, new_base_reserve: Uint32) -> "LedgerUpgrade":
        return cls(
    ...
    @classmethod
    def ledger_upgrade_flags(cls, new_flags: Uint32) -> "LedgerUpgrade":
        return cls(LedgerUpgradeType.LEDGER_UPGRADE_FLAGS, new_flags=new_flags)

    @classmethod
    def ledger_upgrade_config(
        cls, config_setting: LedgerUpgradeConfigSetting
    ) -> "LedgerUpgrade":
        return cls(
            LedgerUpgradeType.LEDGER_UPGRADE_CONFIG, config_setting=config_setting
        )
