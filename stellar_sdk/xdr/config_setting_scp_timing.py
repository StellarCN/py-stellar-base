...
class ConfigSettingSCPTiming:
    ...
    def __init__(
        ...
        self.ledger_target_close_time_milliseconds = ledger_target_close_time_milliseconds
        self.nomination_timeout_initial_milliseconds = nomination_timeout_initial_milliseconds
        self.nomination_timeout_increment_milliseconds = nomination_timeout_increment_milliseconds
        self.ballot_timeout_initial_milliseconds = ballot_timeout_initial_milliseconds
        self.ballot_timeout_increment_milliseconds = ballot_timeout_increment_milliseconds
    ...
    def __hash__(self):
        return hash((self.ledger_target_close_time_milliseconds, self.nomination_timeout_initial_milliseconds, self.nomination_timeout_increment_milliseconds, self.ballot_timeout_initial_milliseconds, self.ballot_timeout_increment_milliseconds,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.ledger_target_close_time_milliseconds== other.ledger_target_close_time_milliseconds and self.nomination_timeout_initial_milliseconds== other.nomination_timeout_initial_milliseconds and self.nomination_timeout_increment_milliseconds== other.nomination_timeout_increment_milliseconds and self.ballot_timeout_initial_milliseconds== other.ballot_timeout_initial_milliseconds and self.ballot_timeout_increment_milliseconds== other.ballot_timeout_increment_milliseconds
    def __repr__(self):
        out = [
