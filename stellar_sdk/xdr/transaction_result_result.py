...
class TransactionResultResult:
    ...
    @classmethod
    def from_tx_success(cls, results: List[OperationResult]) -> TransactionResultResult:
        return cls(TransactionResultCode.txSUCCESS, results=results)

    @classmethod
    def from_tx_failed(cls, results: List[OperationResult]) -> TransactionResultResult:
