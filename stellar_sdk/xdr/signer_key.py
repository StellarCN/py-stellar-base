...
class SignerKey:
    ...
    @classmethod
    def signer_key_type_ed25519(cls, ed25519: Uint256) -> "SignerKey":
        return cls(SignerKeyType.SIGNER_KEY_TYPE_ED25519, ed25519=ed25519)

    @classmethod
    def signer_key_type_pre_auth_tx(cls, pre_auth_tx: Uint256) -> "SignerKey":
        return cls(SignerKeyType.SIGNER_KEY_TYPE_PRE_AUTH_TX, pre_auth_tx=pre_auth_tx)

    @classmethod
    def signer_key_type_hash_x(cls, hash_x: Uint256) -> "SignerKey":
        return cls(SignerKeyType.SIGNER_KEY_TYPE_HASH_X, hash_x=hash_x)

    @classmethod
    def signer_key_type_ed25519_signed_payload(
