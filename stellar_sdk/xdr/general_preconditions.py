...
class GeneralPreconditions:
    ...
    @classmethod
    def unpack(cls, unpacker: Unpacker) -> "GeneralPreconditions":
    ...
    @classmethod
    def from_xdr_bytes(cls, xdr: bytes) -> "GeneralPreconditions":
    ...
    @classmethod
    def from_xdr(cls, xdr: str) -> "GeneralPreconditions":
    ...
    def __str__(self):
        ...
        return f"<GeneralPreconditions {[', '.join(out)]}>"
