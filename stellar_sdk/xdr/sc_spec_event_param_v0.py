...
class SCSpecEventParamV0:
    ...
    def __hash__(self):
        return hash((self.doc, self.name, self.type, self.location,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.doc== other.doc and self.name== other.name and self.type== other.type and self.location== other.location
    def __repr__(self):
        out = [
            f'doc={self.doc}',
            f'name={self.name}',
