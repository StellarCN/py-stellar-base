...
class SorobanResourcesExtV0:
    ...
    def __init__(
        ...
        if archived_soroban_entries and len(archived_soroban_entries) > _expect_max_length:
            raise ValueError(f"The maximum length of `archived_soroban_entries` should be {_expect_max_length}, but got {len(archived_soroban_entries)}.")
