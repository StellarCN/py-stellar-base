...
class SCSpecUDTEnumV0:
    ...
    def unpack(
        ...
        for _ in range(length):
            cases.append(SCSpecUDTEnumCaseV0.unpack(unpacker, depth_limit - 1))
        return cls(
            doc=doc,
            lib=lib,
            name=name,
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SCSpecUDTEnumV0:
    ...
    @classmethod
    def from_json_dict(cls, json_dict: dict) -> SCSpecUDTEnumV0:
        doc = String.from_json_dict(json_dict["doc"])
        lib = String.from_json_dict(json_dict["lib"])
        name = String.from_json_dict(json_dict["name"])
        cases = [
            SCSpecUDTEnumCaseV0.from_json_dict(item) for item in json_dict["cases"]
        ]
        return cls(
            doc=doc,
            lib=lib,
