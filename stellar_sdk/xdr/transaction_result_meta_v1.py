...
class TransactionResultMetaV1:
    ...
    def __hash__(self):
        return hash((self.ext, self.result, self.fee_processing, self.tx_apply_processing, self.post_tx_apply_fee_processing,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.ext== other.ext and self.result== other.result and self.fee_processing== other.fee_processing and self.tx_apply_processing== other.tx_apply_processing and self.post_tx_apply_fee_processing== other.post_tx_apply_fee_processing
    def __repr__(self):
        out = [
            f'ext={self.ext}',
