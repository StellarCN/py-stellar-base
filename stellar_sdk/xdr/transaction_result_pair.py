...
class TransactionResultPair:
    ...
    def unpack(
        ...
        result = TransactionResult.unpack(unpacker, depth_limit - 1)
        return cls(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionResultPair:
    ...
    @classmethod
    def from_json_dict(cls, json_dict: dict) -> TransactionResultPair:
        transaction_hash = Hash.from_json_dict(json_dict["transaction_hash"])
        result = TransactionResult.from_json_dict(json_dict["result"])
        return cls(
            transaction_hash=transaction_hash,
            result=result,
        )
