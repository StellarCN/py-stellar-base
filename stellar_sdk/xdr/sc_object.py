...
class SCObject:
    ...
    @classmethod
    def sco_vec(cls, vec: SCVec) -> "SCObject":
        return cls(SCObjectType.SCO_VEC, vec=vec)

    @classmethod
    def sco_map(cls, map: SCMap) -> "SCObject":
        return cls(SCObjectType.SCO_MAP, map=map)

    @classmethod
    def sco_u64(cls, u64: Uint64) -> "SCObject":
        return cls(SCObjectType.SCO_U64, u64=u64)

    @classmethod
    def sco_i64(cls, i64: Int64) -> "SCObject":
        return cls(SCObjectType.SCO_I64, i64=i64)

    @classmethod
    def sco_bytes(cls, bin: bytes) -> "SCObject":
        return cls(SCObjectType.SCO_BYTES, bin=bin)

    @classmethod
    def sco_big_int(cls, big_int: SCBigInt) -> "SCObject":
        return cls(SCObjectType.SCO_BIG_INT, big_int=big_int)

    @classmethod
    def sco_contract_code(cls, contract_code: SCContractCode) -> "SCObject":
        return cls(SCObjectType.SCO_CONTRACT_CODE, contract_code=contract_code)

    @classmethod
    def sco_account_id(cls, account_id: AccountID) -> "SCObject":
