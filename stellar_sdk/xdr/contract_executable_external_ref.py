...
class ContractExecutableExternalRef:
    ...
    def unpack(
        ...
        tag = SCString.unpack(unpacker, depth_limit - 1)
        return cls(
    ...
    @classmethod
    def from_xdr_bytes(cls, xdr: bytes) -> ContractExecutableExternalRef:
    ...
    @classmethod
    def from_xdr(cls, xdr: str) -> ContractExecutableExternalRef:
    ...
    def from_json_dict(cls, json_dict: dict) -> ContractExecutableExternalRef:
        ...
        tag = SCString.from_json_dict(json_dict["tag"])
        return cls(
            executable_owner=executable_owner,
            tag=tag,
        )
