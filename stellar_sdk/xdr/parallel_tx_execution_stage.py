...
class ParallelTxExecutionStage:
    ...
    def __init__(self, parallel_tx_execution_stage: List[DependentTxCluster]) -> None:
        ...
        if parallel_tx_execution_stage and len(parallel_tx_execution_stage) > _expect_max_length:
            raise ValueError(f"The maximum length of `parallel_tx_execution_stage` should be {_expect_max_length}, but got {len(parallel_tx_execution_stage)}.")
