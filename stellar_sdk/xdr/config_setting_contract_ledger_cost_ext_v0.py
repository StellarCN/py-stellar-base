...
class ConfigSettingContractLedgerCostExtV0:
    ...
    def __hash__(self):
        return hash((self.tx_max_footprint_entries, self.fee_write1_kb,))
    def __eq__(self, other: object):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return self.tx_max_footprint_entries== other.tx_max_footprint_entries and self.fee_write1_kb== other.fee_write1_kb
    def __repr__(self):
        out = [
