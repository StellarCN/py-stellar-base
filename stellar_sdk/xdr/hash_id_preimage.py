...
class HashIDPreimage:
    ...
    @classmethod
    def envelope_type_contract_id_from_contract(
    ...
    @classmethod
    def envelope_type_contract_id_from_asset(
    ...
    @classmethod
    def envelope_type_contract_id_from_source_account(
