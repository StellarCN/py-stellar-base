...
class Keypair:
    ...
    * :meth:`Keypair.from_public_key`
    ...
    @classmethod
    def from_mnemonic_phrase(cls, mnemonic: str, passphrase: str = "", index: int = 0):
        """Generate a :class:`Keypair` object via a mnemonic
        phrase.

        :param mnemonic: A unique string used to deterministically generate keypairs.
        ...
        """
        raw_ed25519_seed = StellarMnemonic.to_seed(mnemonic, passphrase, index)
