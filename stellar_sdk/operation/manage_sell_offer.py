...
class ManageSellOffer(Operation):
    ...
    @classmethod
    def from_xdr_object(cls, operation_xdr_object: Xdr.types.Operation) -> 'ManageSellOffer':
        ...
        buying = Asset.from_xdr_object(operation_xdr_object.body.manageSellOfferOp.buying)
