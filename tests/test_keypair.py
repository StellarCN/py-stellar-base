...
class TestKeypair:
    ...
    def test_create_from_secret(self):
        ...
        assert kp.public_key() == 'GDFQVQCYYB7GKCGSCUSIQYXTPLV5YJ3XWDMWGQMDNM4EAXAL7LITIBQ7'
        assert kp.secret() == secret

    @pytest.mark.parametrize('invalid_secret', [
        '',
        'hello',
    ...
    def test_create_from_public_key(self):
        ...
        assert isinstance(kp, Keypair)
        assert kp.public_key() == 'GAXDYNIBA5E4DXR5TJN522RRYESFQ5UNUXHIPTFGVLLD5O5K552DF5ZH'
        assert kp.raw_public_key().hex() == '2e3c35010749c1de3d9a5bdd6a31c12458768da5ce87cca6aad63ebbaaef7432'

    @pytest.mark.parametrize('invalid_public_key', [
        '',
        'hello'
    ...
    def test_can_sign(self):
        can_sign_kp = Keypair.from_secret('SD7X7LEHBNMUIKQGKPARG5TDJNBHKC346OUARHGZL5ITC6IJPXHILY36')
        can_not_sign_kp = Keypair.from_public_key('GAXDYNIBA5E4DXR5TJN522RRYESFQ5UNUXHIPTFGVLLD5O5K552DF5ZH')
    ...
    def test_sign_and_verify(self):
        kp = Keypair.from_secret('SAQVS3IPN6U3TBMTXQH32ZESY7SUOZGLEFBH6XWMA6DVNPJ4CLO5M54B')
        data = b'Hello, overcat!'
        signature = kp.sign(data)
        assert signature.hex() == 'ff7c4346977144019e7be0c12c033e99f412e70361924e298e6152dd924c88f2' \
    ...
    def test_get_key_of_expected_type_raise(self):
        ...
        with pytest.raises(TypeError,
                           match="The given key_type={} is not of type {}.".format(type(fake_data), fake_expected)):
