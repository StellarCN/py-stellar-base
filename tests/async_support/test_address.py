...
from stellar_base.async_support.horizon import Horizon, HORIZON_TEST, HORIZON_LIVE
...
class TestAddress(object):
    ...
    async def test_get_data(self, test_data):
        ...
        for resp in await asyncio.gather(
                addr.payments(), addr.operations(), addr.effects(), addr.offers(),
                addr.trades(), addr.transactions()):
