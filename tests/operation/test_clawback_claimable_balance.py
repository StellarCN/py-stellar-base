...
from stellar_sdk import ClawbackClaimableBalance, Operation
...
class TestClawbackClaimableBalance:
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                None,
                "AAAAAAAAABQAAAAA2g1X2n1IUOf8ENKp0OvHMfevtAV0wDOVsX1JFJuR9b4=",
                id="without_source",
            ),
            pytest.param(
                kp1.public_key,
                "AAAAAQAAAABiXz1Zw/ieWRoG2l4IxdbkvfDRUDq5wyKBSUnrCR5doQAAABQAAAAA2g1X2n1IUOf8ENKp0OvHMfevtAV0wDOVsX1JFJuR9b4=",
                id="with_source_public_key",
            ),
            pytest.param(
                muxed1,
                "AAAAAQAAAQAAAAAAAAAAAWJfPVnD+J5ZGgbaXgjF1uS98NFQOrnDIoFJSesJHl2hAAAAFAAAAADaDVfafUhQ5/wQ0qnQ68cx96+0BXTAM5WxfUkUm5H1vg==",
